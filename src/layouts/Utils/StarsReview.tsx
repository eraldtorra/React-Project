    ...
    return (
        <div>
            ...
            {Array.from({ length: halfStars }, (_, i) =>
                <svg
                    key={i} xmlns="http://www.w3.org/2000/svg" width={props.size} height={props.size} fill="currentColor" className="bi bi-star-half" style={{ color: "gold" }} viewBox="0 0 16 16">
